...
# К основным типам данных в SQL относятся:
...
# С транзакциями также связаны два важных понятия: блокировки и уровни изоляции. С помощью блокировок СУБД гарантирует,
# что параллельные операции не соперничают друг с другом, а выполняются последовательно, одна за другой.
...
# Задание 3.17.2 Самостоятельно напишите и выполните применительно к БД объявлений следующие виды запросов:
#  1. Создание структуры БД.
#  2. Наполнение БД некоторыми тестовыми данными.
#  3. Переименование одной из таблиц.
#  4. Получение всех объявлений.
#  5. Получение всех объявлений с именами пользователей.
#  6. Получение всех объявлений для некоторого ключевого слова.
#  7. Добавление столбца с временем создания в таблицу объявлений.
#  8. Добавление ограничения проверки времени создания объявления: объявление должно быть создано позднее 1 января 2021 года в формате Unix Time.
